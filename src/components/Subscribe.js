      ...
      <div id="mc_embed_signup">
        <form action="https://gmail.us21.list-manage.com/subscribe/post?u=6c97b13bfff0551faae535089&amp;id=4d854faf2e&amp;f_id=0015ece6f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank">
          <div id="mc_embed_signup_scroll">
            <h2 style={{marginBottom:'0', color:''}} className='subscribeText'>Subscribe for newsletter</h2>
            <div className="mc-field-group">
              <label htmlFor="mce-EMAIL" style={{marginTop:'0', color:''}} className='subscribeText'>Email Address <span className="asterisk">*</span></label>
            ...
            <div className="optionalParent">
              <div className="clear foot">
                ...
                <p style={{ margin: '0px auto' }}>
                  <a href="http://eepurl.com/iHCYok" title="Mailchimp - email marketing made easy and fun">
                    <span style={{ display: 'inline-block', backgroundColor: 'transparent', borderRadius: '4px' }}>
                      <img className="refferal_badge" src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/intuit-mc-rewards-text-dark.svg" alt="Intuit Mailchimp" style={{ width: '100%', height: '', display: 'flex', padding: '2px 0px', justifyContent: 'center', alignItems: 'center' }} />
                    </span>
                  </a>
                </p>
              </div>
